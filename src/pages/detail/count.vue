<template>
  <div class="sales-board">
      ...
      <div class="sales-board-form">
          <div class="sales-board-line">
              ...
              <div class="sales-board-line-right">
                  <v-chooser :selections="productTypes" @on-change="onParamChange('productType',$event)"></v-chooser>
              </div>
          </div>
          <div class="sales-board-line">
              <div class="sales-board-line-left">
              ...
              <div class="sales-board-line-right">
                  <v-selection :selections="districts" @on-change="onParamChange('region', $event)"></v-selection>
              </div>
          </div>
          <div class="sales-board-line">
              <div class="sales-board-line-left">
      ...
      <my-dialog :is-show="isShowErrorDialog" @on-close="hideErrorDialog">
        SORRY ERROR
      </my-dialog>
      </div>
...
export default {
  ...
  methods:{
    ...
    getPrice(){
      ...
      this.$http.get('/api/getPrice',passParams).
      then((res)=>{
    ...
    confirmBuy(){
     let passParams={
      ...
      this.$http.get('/api/createOrder',passParams).
        then((res)=>{
